...
> However, It doesn't work on GNOME as TS6 only receives key presses when an XWayland application is focused, but not when a native Wayland app is focused.
